...
namespace Kata_sandbox
{
    class Program
    {
        ...
        {
            int temp; //Перменная для обменов
            int indexMax = 0; //Индекс максимального элемента в массиве
            for(int i = 0; i < mass.Length; i++) //Начинаем обходки массива
            {
                for(int j = 0; j < mass.Length - i; j++)//Обход элементов в массиве
                {
